...
```
  ...
  -h, --help                                     help for update
      ...
      --notifierId string                        System-generated unique identifier assigned to each notification method. This identifier is needed when updating third-party notifications without requiring explicit authentication credentials.
